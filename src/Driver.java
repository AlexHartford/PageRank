...
public class Driver {
    ...
    public static void main(String[] args) {
        //times(0, 1);
        PageRank.rank(generateDemoData());
    }

    /**
     * Generate simple demo article data
     *
     * @return Array of demo article data
     */
    private static Article[] generateDemoData() {
